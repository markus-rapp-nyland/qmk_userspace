...
[BASE_MAC] = LAYOUT(
   ...
   MAC_BSPC, KC_A, KC_R, KC_S, KC_T, KC_G,                      KC_M, KC_N,    KC_E,   KC_I,    KC_O,  MAC_QUOT,
...
// win alt overrides
const key_override_t alt_e_ae = ko_make_basic(MOD_MASK_ALT, KC_E, NO_AE);
const key_override_t alt_o_oe = ko_make_basic(MOD_MASK_ALT, KC_O, NO_OE);
const key_override_t alt_a_aa = ko_make_basic(MOD_MASK_ALT, KC_A, NO_AA);
